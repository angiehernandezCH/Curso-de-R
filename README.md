...
|  14|   9|T    |`tidyverse`, pipes y funciones básicas con `dplyr`                     |`readr()` `tibble()` `%>%` `arrange()` `select()` `filter()`                                                   |        |[`[Todos]`](https://puc.zoom.us/j/82739444720)                                    |[`[Slides]`](https://mebucca.github.io/dar_soc4001/slides/class_4/class_4#1) [`[.Rmd]`](slides/class_4/class_4.Rmd) |
