...
|---:|---:|:----|:----------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------|:-------|:-----------------------------------------------|:---------------------------|
|  24|   8|T    |Introducción a R y Rstudio                                             |`install.packages()` `library()` `setwd()` `c()` `seq()` `rep()` `sample()`                                    |        |[`[Todos]`](https://puc.zoom.us/j/82739444720)                                    |[`[Slides]`](https://mebucca.github.io/dar_soc4001/slides/class_1/class_1#1) [`[.Rmd]`](slides/class_1/class_1.Rmd)[`[Grabación]`](https://puc.zoom.us/rec/play/ck5xFbTdwCoQ41CDqFn-WVR3lF_ARplCkOgYoI2IwoLRo-axts7k3dTKu0TLTMYDLLV5jjbfqJ8kbrA1.VGr04CT6AOfgX26c?continueMode=true&_x_zm_rtaid=RtpgE8VKRTGmhOttsZe9Ag.1629900191167.44bcc37747c5964f615b764bc410bf69&_x_zm_rhtaid=679) |
...
|  31|   8|T    |Introducción a bases de datos en R                                     |`data.frame()` `list()` `summary()` `table()` `for()` `plot()`                                                 |        |[`[Todos]`](https://puc.zoom.us/j/82739444720)                                    |[`[Slides]`]() [`[.Rmd]`]() |
