...
|  26|   8|P    |Introducción a R y Rstudio                                             |`install.packages()` `library()` `setwd()` `c()` `seq()` `rep()` `sample()`                                    |        |[`[G1]`](https://puc.zoom.us/j/81100821642?pwd=RnlLcjVJUjRPQjlZTDZIYWtIVkdDdz09) [`[G2]`](https://puc.zoom.us/j/84563901846) [`[G3]`](https://puc.zoom.us/j/81632436083?pwd=RmZHMTgzRU1iZzFVbTc1S1hnWFNQQT09) |[`[RScript]`](slides/class_1/class_1.R)             |
