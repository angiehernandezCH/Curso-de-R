...
| 20   | 9    | P     | `tidyverse`, pipes y funciones básicas con `dplyr`                      | `readr()` `tibble()` `%>%` `arrange()` `select()` `filter()`                                                    |          | [`[Todos]`](https://puc.zoom.us/rec/play/B1YllriY-aFvEZSrpAYC5tRVPhW6acMbhwQV3SUEfTC6zi6_WeOiykUO578ezs3KyVEAqjAY3A9woVRf.djpAwUaLBcuvjYpg?continueMode=true&_x_zm_rtaid=yXi6w6p2QpuvJJPw5nErhg.1663678039515.2d3d11a48f725daf4c7f6f36218779c5&_x_zm_rhtaid=175)                                                                                      | [`[Slides]`](https://mebucca.github.io/dar_soc4001/slides/class_5/class_5#1) [`[.Rmd]`](slides/class_5/class_5.Rmd)                                                                                                                          |
