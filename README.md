...
|   2|   9|P    |Introducción a bases de datos en R (CASEN 2020)                        |`data.frame()` `list()` `summary()` `table()` `for()` `plot()`                                                 |        |[`[G1]`](https://puc.zoom.us/j/88353014380) [`[G2]`](https://puc.zoom.us/j/84812585003) [`[G3]`](https://puc.zoom.us/j/89222482219?pwd=cFFUdm9GR0Iza1dTaFhieElwbFJrZz09) |[`[RScript]`](slides/class_3/class_3.R)  [`[Casen2020]`](http://observatorio.ministeriodesarrollosocial.gob.cl/storage/docs/casen/2020/Casen_en_Pandemia_2020_SPSS.sav.zip)              |
